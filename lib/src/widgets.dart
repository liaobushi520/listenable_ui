...
class EditableTextExState extends StateMixinListener<EditableTextEx> {
  ...
  @override
  List<Listenable> collectListenable() => [this.widget.data];
}
...
class ImageEx extends StatefulWidget {
  ...
  final ValueNotifier<String> src;
...
class ImageExState extends StateMixinListener<ImageEx> {
  @override
  List<Listenable> collectListenable() => [this.widget.src];
...
class _CheckboxExState extends StateMixinListener<CheckboxEx> {
...
class _ListViewExState extends StateMixinListener<ListViewEx> {
  @override
  Widget build(BuildContext context) {
  ...
  @override
  List<Listenable> collectListenable() => [this.widget.items];
}
...
class ExchangeExState extends StateMixinListener<ExchangeEx> {
  @override
  Widget build(BuildContext context) {
    return Stack(
      children: <Widget>[
  ...
  @override
  List<Listenable> collectListenable() => [this.widget.status];
}
